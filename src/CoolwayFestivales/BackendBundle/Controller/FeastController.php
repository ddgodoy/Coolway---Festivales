...
//                ->setAcl(array("OWNER")) //OWNER,OPERATOR,VIEW
    ...
    /**
     * Edits an existing Feast entity.
     *
     * @Route("/update/{id}", name="admin_feast_update")
     * @Method("post")
     * @Template("BackendBundle:Feast:edit.html.twig")
     */
     ...
     * @Route("/bachdelete", name="admin_feast_bachdelete")
     * @Template()
     */
